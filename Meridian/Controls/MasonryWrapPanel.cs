...
namespace Meridian.Controls
{
    ...
    public class MasonryWrapPanel : Panel
    {
        ...
        private void MasonryWrapPanel_Loaded(object sender, Windows.UI.Xaml.RoutedEventArgs e)
        {
        ...
        private void MasonryWrapPanel_Unloaded(object sender, Windows.UI.Xaml.RoutedEventArgs e)
        {
            if (_scrollViewer != null)
                _scrollViewer.ViewChanged -= ScrollViewer_ViewChanged;
